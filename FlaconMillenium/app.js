...
const LOCATION = require('./routes/bdd/location.js')
const PERSON = require('./routes/bdd/person.js')
const SERVEDWITH = require('./routes/bdd/servedWith.js')
const BOTTLE = require('./routes/bdd/bottle.js')
const WINE = require('./routes/bdd/wine.js')
const WINEACCOMPANIMENT = require('./routes/bdd/wineAccompaniment.js')
const WINECEPAGE = require('./routes/bdd/wineCepage.js')
...
App.use('/servedwith', SERVEDWITH)
App.use('/bottle', BOTTLE)
App.use('/wine', WINE)
App.use('/wineaccompaniment', WINEACCOMPANIMENT)
App.use('/winecepage', WINECEPAGE)
